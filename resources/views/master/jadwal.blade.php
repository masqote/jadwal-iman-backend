...
@section('content')
    <div class="container-fluid py-4 text-white">
      <div>
        <h4 class="text-white px-2">Master Jadwal</h4>
      </div>
      <div class="card">
        ...
        @endif
        <div class="pt-4 px-4">
          <a href="{{url('/master/jadwal/add')}}">
            <button class="btn btn-icon btn-3 btn-primary" type="button">
              <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
              <span class="btn-inner--text">Add Jadwal</span>
            </button>
          </a>
        </div>
          ...
          <table class="table table-bordered align-items-center mb-10" id="dataSource">
            <thead>
              <tr class="text-black font-weight-bold">
                ...
                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Ustadz</th>
                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7  ">Judul</th>
                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7  ">Tipe Kajian</th>
                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Masjid</th>
                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Propinsi</th>
